...
See current binary/exe in the binary-dev directory (you need to run it in a directory with the relevant DLLs it needs, now including mingw-w64-ucrt-x86_64-fdk-aac, which wasn't part of RC1)
