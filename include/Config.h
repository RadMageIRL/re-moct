...
struct DigiConfig {
    ...
    int   repin_mode            = 2;       // iHeart re-pin (F6): 0=off, 1=ad-escape (hard ad-evidence only), 2=hybrid (evidence or spot segments in the timed window; default), 3=timed (legacy duration-only - will thrash talk shows)
